    ...
    <AuthShell
      ...
      subtitle={
        stage === "success"
          ...
          : "We'll automatically detect whether your PocketOption account belongs to Nebz or Nyathira."
      }
      footer={
        stage === "form" ? (
      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "loading" && (
          ...
          >
            ...
            <p className="mt-6 text-sm text-foreground">Verifying with PocketOption…</p>
            <p className="mt-2 text-xs text-muted-foreground">
              Verifying your PocketOption account. This usually takes a few seconds.
            </p>
          </motion.div>
        )}
        ...
        {stage === "success" && (
          ...
          >
            ...
            <p className="mt-6 text-base text-foreground">
              Your PocketOption account has been verified successfully.
            </p>
            {verifiedUnder && (
            ...
            {failureReason === "no_marketplace_account" ? (
              <>
                <p className="text-base text-foreground">
                  {failureMessage ??
                    "Your PocketOption account was verified, but we couldn't find a TradersHub Marketplace account for your email."}
                </p>
              ...
              <>
                <p className="text-base text-foreground">
                  We could not verify this PocketOption account under Nebz or Nyathira.
                </p>
                <div className="mt-8 flex flex-col gap-3">
                  <LuxButton onClick={() => setStage("form")}>TRY AGAIN</LuxButton>
                  <LuxButton variant="ghost" onClick={() => navigate({ to: "/dashboard" })}>
